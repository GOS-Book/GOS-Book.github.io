...
% \usepict : To use it outside of everything, the simliest construction:  
% \usepict{picturename without pictures/}{part of textHEIGHT}

% \insertpicture : To use inside environments like proof:  
% \insertpicture[the number of supplementary lines to be shortened = 6 by default]{picturename without pictures/}{part of textWIDTH}
...
\newcommand{\usepict}[2]{
\begin{center}
\captionsetup{type=figure}\includegraphics[height=#2\textheight]{pictures/#1}\refstepcounter{pictnumber}\label{#1}\captionof{figure}{}
\end{center}}
...
\checkoddpage%
\ifoddpage%
\InsertBoxR{0}{\begin{threeparttable}\begin{tabular}{c@{}}\captionsetup{type=figure}\includegraphics[width=#3\textwidth]{pictures/#2}\refstepcounter{pictnumber}\label{#2}\end{tabular}\captionof{figure}{}\end{threeparttable}}[#1]%
\else%
\InsertBoxL{0}{\begin{threeparttable}\begin{tabular}{c@{}}\captionsetup{type=figure}\includegraphics[width=#3\textwidth]{pictures/#2}\refstepcounter{pictnumber}\label{#2}\end{tabular}\captionof{figure}{}\end{threeparttable}}[#1]%
\fi%
}

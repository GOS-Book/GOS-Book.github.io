...
\newenvironment{defnn}[1] %MANUAL NUMBERING IN DEFINITIONS with \begin{defnn}{mynumber}
...
\newenvironment{consn}[1]
  {\renewcommand\thecons{#1}\cons}
  {\endcons}
...
\newenvironment{lemmn}[1]
  {\renewcommand\thelemm{#1}\lemm}
  {\endlemm}

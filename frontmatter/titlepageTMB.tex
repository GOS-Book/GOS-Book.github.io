...
\draw[anchor=north] (midpoint) node [fill=prpl!30!white,fill opacity=0.6,text opacity=1,inner sep=0.8cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering { \textcolor{black!100}{\fontsize{23}{14}\selectfont GOSBook}}\\[4pt] % Book title
%{\Large }\\[20pt] % Subtitle

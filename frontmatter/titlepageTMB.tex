...
\draw[anchor=north] (midpoint) node [fill=prpl!30!white,fill opacity=0.6,text opacity=1,inner sep=0.8cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering { \textcolor{black!100}{\fontsize{23}{14}\selectfont GOS-Book}}\\[4pt] % Book title
%{\Large }\\[20pt] % Subtitle
{\textcolor{black!100}{\huge Didenko Andr\'e}}\\[2pt] % Author name
{\textcolor{black!100}{\LARGE\scshape Edition from \twodigit\day.\twodigit\month.\the\year}}
}}; 
\end{tikzpicture}};
\end{tikzpicture}
\vfill
...
\item Анкета о ГОСе для ознакомления, но также прошу вас заполнить ее после сдачи экзамена:

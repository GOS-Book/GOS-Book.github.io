## GOS_book
#### Новости
Эй, TeX-отряд, добавляем страницы картиночек, которые надо будет потом залить в файл todo.tex и вообще, всё, что оставляете на дальнейшее потом. В следующей таблице наш прогресс.
####Таблица прогресса

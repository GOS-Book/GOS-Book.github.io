...
\qquad\textcolor{Purplemountainmajesty}{$\blacktriangleright$}\ \href{http://latexonline.cc/compile?git=https://github.com/DidenkoAndre/GOS_book&target=_main.tex}{\large \textcolor{Purplemountainmajesty}{$latexonline.cc/...$}}
...
\footnotetext{Для оформления подписки используйте команду \textsf{/subscribe}.}

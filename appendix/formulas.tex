...
\tabularnewline \multicolumn{2}{@{\extracolsep{\fill}}l}{$\int\frac{dx}{x^2+a^2} = \frac{1}{a}\arctg\frac{x}{a} + C = -\frac{1}{a}\arctg\frac{x}{a} + C,\, a\neq 0; $}
\tabularnewline \multicolumn{2}{@{\extracolsep{\fill}}l}{$\int\frac{dx}{x^2-a^2} = \frac{1}{2a}\ln\left|\frac{x-a}{x+a}\right| + C, \, a\neq 0 ;$ }
\tabularnewline \multicolumn{2}{@{\extracolsep{\fill}}l}{$\int\frac{dx}{\sqrt{a^2-x^2}} = \arcsin\frac{x}{a} + C=-\arccos\frac{x}{a} + C$, $|x|<a$, $a\neq 0$;}
\tabularnewline \multicolumn{2}{@{\extracolsep{\fill}}l}{$\int\frac{dx}{\sqrt{x^2+a^2}} = \ln|x+\sqrt{x^2+a^2}|+C$, $a\neq 0$;}
\tabularnewline\multicolumn{2}{@{\extracolsep{\fill}}l}{$\int\frac{dx}{\sqrt{x^2-a^2}}= \ln|x+\sqrt{x^2-a^2}|+C$, $a\neq 0$, $|x|>|a|$.}
\end{longtable}

...
\begin{longtable}[l]{@{\extracolsep{\fill}}|p{0.45\textwidth}|p{0.45\textwidth}|p{0.015\textwidth}|}
	...
	\multicolumn{2}{@{\extracolsep{\fill}}|l|}{
		$(1+x)^{a}=1+ax+\dfrac{a(a-1)}{2}x^2+\dfrac{a(a-1)(a-2)}{6}x^3$}
	&
	$1$
	\\
	\multicolumn{2}{@{\extracolsep{\fill}}|l|}{
		 напр. $\frac{1}{1-x}=1+x+x^2+x^3$}
	&
	\\\hline
\end{longtable}
...
$$
\newpage
\begin{longtable}[l]{@{\extracolsep{\fill}}|p{0.41\textwidth}|p{0.46\textwidth}|p{0.08\textwidth}|}
\hline

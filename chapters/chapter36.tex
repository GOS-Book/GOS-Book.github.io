...
$\int_1^{+\infty} O \left( \frac{1}{x^{m - n + 1}} \right)\,dx$ сходится абсолютно, так как по условию $m - n + 1 \ge 2$. Сходимость интеграла $\eqref{ch36.1eq23}$ в $-\infty$ при $m — n \ge 1$ проверяется аналогично.

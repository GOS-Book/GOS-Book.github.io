...
\item
В точке  $(x_0,y_0)$ были выполнены следующие условия (называемые условиями Коши-Римана)\footnotemark:
\begin{equation}
\label{exp17}
\begin{split}
...
\end{enumerate}
\end{thm}
\footnotetext{Для краткости, примем следующее обозначение для частных производных $\pd{\textstyle u}{ \textstyle x}=u'_x.$}
\begin{proof}
$ $\linebreak
\vspace*{-\baselineskip}
\begin{itemize}

...
\begin{equation*}
\begin{split}
&J_1 \myeq{\eqref{abc6}} \iint_D \left(-\pd{v}{x}-\pd{u}{y}\right)\,dx\,dy \xlongequal{\text{ \href{https://vk.com/exferro}{\scriptsize \textcolor{black}{УКР}}}} 0,\\
&J_2 \myeq{\eqref{abc6}} \iint_D \left(\pd{u}{x}-\pd{v}{y}\right)\,dx\,dy \xlongequal{\text{\href{https://vk.com/exferro}{\scriptsize \textcolor{black}{УКР}}}} 0,
\end{split}
\end{equation*} 

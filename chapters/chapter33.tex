...
Проще говоря, множество $G$ называется \textit{звездным}\rindex{множество!звездное}, если можно найти такую точку (\textit{центр звёздного множества}), что все прямые отрезки, соединяющие ее с любой другой, целиком принадлежат $G$.
\end{defn}
\begin{center}

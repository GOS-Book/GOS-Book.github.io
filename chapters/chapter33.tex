\part[Теория функций комплексного переменного]{\raggedleft Теория функций комплексного переменного}%\protect\linebreak \vbox{\vspace*{5\baselineskip}}\centerline{\includegraphics[height=0.3\textheight]{pictures/Foxi/10}}}

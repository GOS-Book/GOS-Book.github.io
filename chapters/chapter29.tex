...
Очевидно, что $\forall y(x)\in M$ интеграл \eqref{ch29eq1} определен и задает функционал (отображение $F \colon M \to \bbR$) с областью определения $M$ в пространстве $C^1[a,b]$.

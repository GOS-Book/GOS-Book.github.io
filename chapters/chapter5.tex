...
Равенство $$f(x) = P_n(x) + r_n(x)$$ называется \textit{формулой Тейлора}\rindex{формула!Тейлора} для функции $f(x)$ в точке $x_0$, а функция $r_n(x)$ "--- остаточным членом формулы Тейлора.

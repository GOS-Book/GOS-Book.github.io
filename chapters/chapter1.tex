...
&+\infty\cdot a = -\infty \quad\text{и}\quad -\infty\cdot a = +\infty, \quad \forall a < 0,\  a\in\bbR\cup\{-\infty\};\\
&a/ -\infty = 0 \quad\text{и}\quad a / +\infty = 0, \quad \forall a \in \bbR;
\end{alignat*}
...
$$
\forall x \in \bbR \cquad x \le M \quad (\text{соотв., }x \ge M)
$$
\end{defn}
\begin{defn}
Множество $G\subset \bbR$ называется \textit{ограниченным сверху (снизу)}, если существует верхняя (нижняя) грань этого множества:
$$
\exists M \in \bbR \cquad \forall x \in \bbR \cquad x \le M \quad (\text{соотв., } x \ge M)
$$
...
$M\in G$,
\item
$\forall x \in G\cquad x \le M \quad (\text{соотв., } x \ge M)$.
\end{enumerate}
\end{defn}

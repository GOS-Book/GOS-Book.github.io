...
%\addmppict[0.8]{pictures/ch35pict3}{0.4}{
\usepict{ch35pict3}{0.2}
...
\end{defn}
\begin{center}
\includegraphics[width=0.7\textwidth]{pictures/ch35pict4}\refstepcounter{pictnumber} Рис. \thepictnumber
\end{center}
...
\end{equation}
\end{thm}
\usepict{ch35pict5}{0.2}
\begin{proof}
Поскольку область ограничена, то значит одна группа компонент, <<внешняя>> компонента, образует кусочно-гладкий замкнутый контур, который отделяет $G$ от бесконечности. (см. рис.~\ref{ch35pict5})

...
\begin{multline*}
\alpha(x) \overset{x \to x_0}{\Longrightarrow} 0 \quad \Rightarrow \quad \exists \delta > 0: \forall x \in \overset{\circ}{O}_\delta(x_0) \cap D_f: f(x) - f(x_0) \ge \frac{1}{2}|h|^2 \left( m - \frac{m}{2} \right) = \frac{m}{4}|h|^2 > 0 \\ \quad \Rightarrow \quad \text{Теорема} \ref{ch10thm3}
\end{multline*}
\end{proof}
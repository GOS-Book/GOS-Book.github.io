\part[Многомерный анализ, интегралы и ряды (продолжение)]{Многомерный анализ,\protect\linebreak интегралы и ряды.\protect\linebreak(продолжение) \protect\linebreak 
\vbox{\vspace*{5\baselineskip}}
\centerline{\includegraphics[height=0.3\textheight]{pictures/Foxi/3}}}

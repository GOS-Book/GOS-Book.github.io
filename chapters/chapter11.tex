\part[Многомерный анализ, интегралы и ряды (продолжение)]{Многомерный анализ,\protect\linebreak интегралы и ряды.\protect\linebreak(продолжение)}% \protect\linebreak \vbox{\vspace*{5\baselineskip}}\centerline{\includegraphics[height=0.3\textheight]{pictures/Foxi/3}}}

\chapter[\texorpdfstring{Свойства интеграла с переменным верхним пределом \protect\newline (непрерывность, дифференцируемость).\protect\newline Формула Ньютона-Лейбница.}{}]{Свойства интеграла с переменным верхним пределом (непрерывность, дифференцируемость). Формула Ньютона-Лейбница.}
